...
urlpatterns = [
    # Subscription plnas
    path(f'plans/', views.SubscriptionPlanListView.as_view(), name='subscription-plans'),
    path('plans/<int:pk>/', views.SubscriptionPlanDetailView.as_view(), name='subscription-plans-detail'),
    ...
    path('pinned-post', views.pinned_posts_list, name='pinned-posts-list'),
