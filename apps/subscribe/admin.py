...
class SubscriptionAdmin(admin.ModelAdmin):
    ...
    search_fields = ('user__username', 'user__email', 'plan__email')
    ...
    fieldsets = (
        ...
        ('Stripe', {
            'fields': ('stripe_subscripttion_id',),
            'classes': ('collapse',),
        }),
        ('Status', {
    ...
    user_link.short_descrtiption = 'User'
    ...
    actions = ['active_subscriptions', 'cancel_subscriptions', 'expire_subscriptions']

    def activate_subscriptions(self, request, queryset):
        '''Активация выбранных подписок'''
        count = 0
